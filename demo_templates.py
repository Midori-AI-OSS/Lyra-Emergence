...
from config.model_recommendations import MODEL_DATABASE


def demo_auto_templates():
    """Demonstrate auto template functionality with different models."""
    print("🎭 Auto Chat Template Demo\n")
    print("This demo shows how Lyra automatically selects the best chat template for each model.\n")
    ...
    test_conversation = [
        ...
        {"role": "assistant", "content": "I'm an AI assistant designed to help you with various tasks and questions."},
    ...
    for model_id in demo_models:
        ...
        try:
            ...
            if info['has_chat_template']:
                ...
                print("⚠ Using fallback template (model doesn't have built-in template)")
            
            # Format the conversation
            formatted = manager.format_conversation(test_conversation, add_generation_prompt=True)
